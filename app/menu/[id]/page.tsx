...
import { getMenuItemById, getReviewsByMenuItemId } from '@/lib/data'
...
export default function ProductDetailPage() {
  ...
  const itemReviews = item ? getReviewsByMenuItemId(item.id) : []
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 md:px-10 py-8">
      ...
      <section className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Customer Reviews ({itemReviews.length})</h2>
